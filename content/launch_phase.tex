...
\\\textbf{WebInterface: }
\\\\\textbf{\huge INSERT NEW PICTURE OF THE WEBPAGE}
\begin{figure}[H]
	\begin{centering}
...
\textbf{\huge MORE DIAGRAMS :D}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{General Architecture Design}
\textbf{\huge What is this all about ??? Update design criteria from IDE}
...
\\\\\textbf{\huge Write intro. Maybe include physical interface in a diagram}\\\\
