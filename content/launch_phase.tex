...
\\[0.2cm] \textbf{Description of the different states: }
	...
	\begin{figure}[H]
		...
		\caption{State Machine Diagram}
	 	\end{centering}
	\end{figure}
\todo[inline]{Make more machines. WEB for instance!!!\\Remove STANDBY FROM state machine!!!}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\\ \todo[inline]{include physical interface in a diagram}
...
\todo[inline]{Making a development plan.}