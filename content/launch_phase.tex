...
\subsection{General Analysis}
	\subsubsection{Requirements	 Analysis}
		...
		\begin{tabular} [b] {| c |  p{3cm} | p{10cm} |}
			...
			F-1.2 & System 		& The hub should be able to communicate with a connected module via. power line communication. \\ \hline
		...
		\begin{table}[h!]
			...
			NF-2.2 & Current 		& The maximum current is defined from the maximum current the wind turbine and the photovoltaic cells can produce. \\ \hline
		\end{tabular}
		...
		\begin{table}[h!]
			...
			B-2.2 & Under-production & If the producing modules does not produce enough energy. \\\hline
	...
	\subsubsection{Usage Domain Analysis}
		...
		\\\textit{Description: }
		An user with administrator privileges that can login to the web interface of the system. This user can manage the energy hub from a computer or mobile device via the web page and have permission to almost anything.
